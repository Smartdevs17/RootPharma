    ...
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-[#0f172a] border border-gray-800 p-6 rounded-2xl hover:border-red-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-red-500/5 cursor-default group">
                    <div className="flex items-center gap-4 mb-4">
